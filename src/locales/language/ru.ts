export default {
  ...
  choose_service: "Выберите услугу или<br/> перейдите в чат с Асель<br/>для консультации",
  make_appointment: "Запись<br/> на прием",
  help_center: "Справочная<br/> информация",
  ask_aigerim: "Спросить у Асель",
  ...
  bot_name: "Асель",
  ready_to_help: "Готова помочь",
  connecting: "Подключение...",
  connection_error: "Ошибка подключения",
  disconnected: "Отключено",
  stop_recording: "Остановить",
  close_chat: "Закрыть х",
  open_keyboard: "Открыть клавиатуру",
  finish_session: "Чтобы завершить",
  session_and_recording: "сессию и запись,",
  press_stop_button: "нажмите на кнопку Стоп",
  ...
  // ApprovePage.vue
  appointment_success_title: "Вы успешно<br/>записались на прием",
  appointment_success_subtitle: "Не забудьте взять талон",
  close_button: "Закрыть х",
  
  // SchedulePage.vue
  select_appointment_date: "Выберите день приёма:",
  select_appointment_time: "Выберите время приёма:",
  book_appointment_button: "Записаться",
  select_doctor: "Выберите врача:",
  select_doctor_placeholder: "Выберите врача",
  appointment_confirmation_title: "Подтверждение записи:",
  patient_label: "Пациент",
  appointment_label: "Прием",
  date_time_label: "Дата и время",
  cabinet_label: "Участок / Кабинет",
  institution_label: "Учреждение",
  cost_label: "Стоимость",
  first_visit_price: "Первый приём:",
  follow_up_price: "Последующий:",
  appointment_instruction_text: "Приходите в назначенное время и дату. Рекомендуем прибыть за 15 минут до приёма",
  confirm_button: "Подтвердить",
  creating_appointment_text: "Создание записи...",
  back_button_text: "Назад",
  close_button_text: "Закрыть х",
